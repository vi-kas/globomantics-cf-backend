...
import com.globomantics.Backend._
import com.globomantics.persistance.Model.Location
...
object ZIPCodeLocator {
  ...
  val apiKey = config.getString("maps.apiKey")
    ...
    maybeAddressComponents
      .map {
        case addressComponents =>
          val (city, country) = (addressComponents
